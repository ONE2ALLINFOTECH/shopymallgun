...
const sendOTP = async (req, res) => {
  ...
  try {
    ...
    if (isEmail) {
      ...
      const url = `http://websms.textidea.com/app/smsapi/index.php?key=368214D9E23633&campaign=8559&routeid=18&type=text&contacts=9368152250&senderid=SHPMOL&msg=${encodeURIComponent(msg)}`;
      try {
